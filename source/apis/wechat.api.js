...
export class WechatApi{
    ...
    notifyc(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/notifyc',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    prepayc(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'wechat/prepayc',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
